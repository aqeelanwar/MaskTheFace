...
for i in range(n):
    ...
    # image_path = 'data/images12.jpg'
    # image_write = 'data/images12_masked.jpg'
    ...
    G = im[1]
    B = im[2]
    T = np.mean(0.2126 * R + 0.7152 * G + 0.0722 * B)
    ...
    out_img = mask_face(image, six_points_on_face,angle, T, type='surgical')
